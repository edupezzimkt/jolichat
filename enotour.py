...
Descrição: é um evento para quem busca celebrar a vida, o vinho, a gastronomia e a música, em um encontro único, rodeado de história.  Em meio ao charme rústico e à sofisticação da Jolimont, o evento oferece uma degustação de rótulos especialmente selecionados para o evento, cercada pela imersão nas barricas de vinho e gastronomia local, uma experiência que ficará gravada na memória de todos os presentes.   O evento será no dia 04/01/2025  Horário: das 20h às 00h Duração da visita: em torno de 4h Localizado Vitivinícola Jolimont, em Canela, RS.   Em caso de chuva o evento ocorrerá normalmente.   O que está incluso: O evento conta com uma degustação (open bar) de vinhos e espumantes, com rótulos cuidadosamente selecionados. A charcutaria é o destaque gastronômico, com uma seleção refinada de queijos artesanais, presuntos curados, salames, embutidos e pães artesanais, e muitos mais, harmonizados perfeitamente com os vinhos servidos. Para tornar o ambiente ainda mais envolvente, a música complementa a noite, proporcionando uma combinação perfeita de vinho e música.  Como vai ser o evento? Boas-vindas Ao chegar na Vinícola, valide seu ingresso na bilheteria, pegue sua taça e nossa equipe irá te conduzir até o local do evento.  O evento ocorre no Tour Jolimont Agora, o local onde você conhece nossa vinícola e sabe mais sobre a nossa história é o palco do evento “Entre Vinhos”. Open bar de bebida Serão diversas salas, cada uma com uma seleção especial de rótulos para você degustar à vontade durante todo o evento. Gastronomia A experiência gastronômica inclui charcutaria local e uma mesa de antepastos, todos perfeitamente harmonizados.Música Enquanto você aprecia nossos rótulos a música toma conta do ambiente durante o evento.Loja Degustou nossos rótulos e se apaixonou? Aproveite a oportunidade para adquiri-los durante o Relatório de Passeios evento, com a orientação dos nossos sommeliers mais experientes. Encerramento O evento encerra às 00h, mas certamente ficará um gostinho de quero mais! Te esperamos para nos visitar e conhecer outros passeios, como o Tour Premium, o Piquenique, ou ainda para apreciar a linda vista que o Terrasse Jolimont oferece.  Tim-tim!  .   Descontos para ingresso antecipado. Ingressos de R$ 350,00 por apenas R$ 250,00/2 pessoas 28% OFF ao comprar o ingresso online visualizando agora GARANTIR MEU INGRESSO Vagas limitadas. 
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [{"role": "assistant", "content": "Olá, estou aqui para ajudar você a escolher o melhor passeios.🍇"}]
